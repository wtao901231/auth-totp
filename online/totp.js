    ...
    function updateOtp() {
        ...
        $('#qrImg').attr('src', 'https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl=200x200&chld=M|0&cht=qr&chl=otpauth://totp/user@host.com%3Fissuer%3Dhttps%3A%2F%2Fgithub.com%2Fwtao901231%2Fauth-totp%26secret%3D' + $('#secret').val());
        $('#secretHex').text(key);
